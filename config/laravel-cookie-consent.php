...
return [
    ...
    */
     ...
     */
    'cookie_title' => "Aviso legal sobre cookies",
     ...
     */
    'cookie_description' => "Este sitio web utiliza cookies para mejorar su experiencia de navegación, analizar el tráfico del sitio y personalizar el contenido. Al continuar utilizando este sitio, acepta nuestro uso de cookies.",
     ...
     * @default 'Accept all'
     */
    'cookie_accept_btn_text' => 'Acceptar todo',
     ...
     * @default 'Reject all'
     */
    'cookie_reject_btn_text' => 'Rechazar todo',
     ...
     */
    'cookie_preferences_btn_text' => 'Gestionar preferencias',
     ...
     */
    'cookie_modal_intro' => 'Puede personalizar sus preferencias de cookies a continuación.',
    ...
    'cookie_categories' => [
        'necessary' => [
            ...
            'description' => 'Estas cookies son esenciales para el funcionamiento adecuado del sitio web.',
        ],
        'analytics' => [
            ...
            'description' => 'Estas cookies nos ayudan a entender cómo interactúan los visitantes con nuestro sitio web.',
        ],
        'marketing' => [
            ...
            'description' => 'Estas cookies se utilizan para publicidad y seguimiento.',
        ],
        'preferences' => [
            'enabled' => env('COOKIE_CONSENT_PREFERENCES', false),
            'locked' => false,
            'title' => 'Cookies de preferencias',
            'description' => 'Estas cookies permiten al sitio web recordar las preferencias del usuario.',
        ],
    ],
    ...
    'policy_links' => [
        [
            ...
            'link' => env('COOKIE_CONSENT_PRIVACY_POLICY_URL', '') ?? url('politicas-de-privacidad')
        ],
        [
            'text' => 'Términos y Condiciones',
            'link' => env('COOKIE_CONSENT_TERMS_URL', '') ?? url('terminos-y-condiciones')
        ],
    ],
];
